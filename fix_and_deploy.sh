...
# ==========================================
# 1. FIX package.json (Add build script)
# ==========================================
echo "=== Step 1: Restoring correct package.json ==="
...
JSON
echo "✔ package.json restored with the build script."

# ==========================================
# 2. PATCH server.ts (Add trust proxy)
# ==========================================
echo "=== Step 2: Patching server.ts for express-rate-limit ==="
if [ -f "server.ts" ]; then
  # Remove any previous trust proxy patching to prevent duplicates
...
# ==========================================
# 3. DEPLOY: solana-pulse-gateway
# ==========================================
echo "=== Step 3: Deploying solana-pulse-gateway ==="
